...
(function () {
  const translations = {
    es: {
      ...
      "hero.trust3": "Tatami Oficial de 250m²",
      ...
      "facility.subtitle": "Ubicado en C/ de Perú, 14 (Planta G), 03008 Alicante. Más de 300 m² dedicados exclusivamente al judo, al brazilian jiu-jitsu y a la preparación física funcional.",
      "facility.matBadge": "TATAMI OFICIAL DE COMPETICIÓN",
      "facility.matTitle": "Tatami Oficial de Competición · Zona de Fuerza & Calistenia",
      "facility.matDesc": "Recepción moderna, iluminación perimetral cálida, tatami continuo sin resquicios y climatización de alta potencia.",
      "facility.matStatLabel": "Tatami",
      "facility.matStatValue": "250 m² Amortiguado",
      "facility.f1Title": "250m² Tatami Oficial Amortiguado",
      "facility.f1Desc": "Superficie de competición de alta densidad con cámara de absorción anti-impactos diseñada para proteger articulaciones en proyecciones y rodajes intensos.",
      "facility.f2Title": "Zona de Fuerza & Calistenia",
      "facility.f2Desc": "Cuerdas de trepar hasta el techo, barras olímpicas, kettlebells, racks y material para tracción y grip específico para judokas y jiu-jitseros.",
      ...
      "faqs.a4": "¡Sí! Disponemos de tarifa plana combinada ilimitada para que puedas entrenar indistintamente tanto Judo Olímpico como Brazilian Jiu-Jitsu (con Gi y No-Gi Grappling), además de acceso libre a todas las sesiones de Tatami Abierto, Open Mat y la zona de fuerza y acondicionamiento.",
    ...
    en: {
      ...
      "hero.trust3": "Official 250m² Shock-Absorbing Tatami",
      ...
      "facility.subtitle": "Located at C/ de Perú, 14 (Ground Floor), 03008 Alicante. Over 300 m² dedicated exclusively to judo, Brazilian jiu-jitsu, and functional athletic conditioning.",
      "facility.matBadge": "OFFICIAL COMPETITION TATAMI",
      "facility.matTitle": "Official Competition Tatami · Strength & Calisthenics Area",
      "facility.matDesc": "Modern reception, warm ambient perimeter lighting, seamless tatami mats, and high-capacity climate control.",
      "facility.matStatLabel": "Tatami",
      "facility.matStatValue": "250 m² Shock-Absorbing",
      "facility.f1Title": "250m² Official Shock-Absorbing Tatami",
      "facility.f1Desc": "High-density competition surface engineered with an impact-absorption subfloor to protect joints during explosive throws and intensive rolling.",
      "facility.f2Title": "Strength & Calisthenics Zone",
      "facility.f2Desc": "Ceiling climbing ropes, Olympic barbells, kettlebells, squat racks, and grip/pull gear tailored specifically for judokas and jiu-jitsu fighters.",
      ...
      "faqs.a4": "Yes! We provide an all-inclusive membership giving you unlimited access to both Olympic Judo and Brazilian Jiu-Jitsu (Gi and No-Gi Grappling), plus open access to Open Mat, sparring sessions, and our functional strength area.",
